        ...
        >
            ...
            >
                <div
                    data-slot="sidebar"
                    className={cn(
                        'flex h-full w-full flex-col bg-tertiary group-data-[intent=floating]:rounded-lg group-data-[intent=floating]:border group-data-[intent=floating]:border-border group-data-[intent=floating]:bg-secondary/50 group-data-[intent=inset]:bg-transparent',
            ...
            {(values) => (
                <>
                    ...
                    <span className="col-start-2 group-data-[collapsible=dock]:hidden">
                        ...
                        {props.badge && (
                            <div
                                className="bdx absolute inset-y-1/2 right-1.5 grid h-[1.30rem] w-auto -translate-y-1/2 place-content-center rounded-md bg-fg/[0.02] px-1 text-xs font-medium text-muted-fg ring-1 ring-fg/20 dark:bg-fg/10">
                                {props.badge}
                            </div>
                        )}
                    </span>
                    ...
                    {typeof title === 'string' && (
                        <span className="group-data-[collapsible=dock]:hidden group-data-[collapsible=dock]:opacity-0">
                            {collapsible ? (
                                ...
                                >
                                    <span
                                        className="flex items-center [&>[data-slot=icon]]:mr-2 [&>[data-slot=icon]]:text-muted-fg">
                                        {Icon && <Icon data-slot="icon"/>}
                                        {title}
                                    </span>
                                    {Icon && (
                                        <IconChevronRight className="idctr"/>
                                    )}
                                    {!Icon && (
                                ...
                                <h4 className="px-3 py-2 text-sm text-muted-fg">
                                    {title}
                                </h4>
                            )}
                        </span>
